...
class OpenRouterClient:
    ...
    def judge(
        self, *, question_text: str, answer: str, rubric: list[dict[str, Any]], execution: ExecutionResult,
        ...
        response = self._request(
            "/chat/completions",
            {
                ...
                "messages": [
                    {
                        "role": "system",
                        "content": "Score an AI-POT learner prompt only from the stated question, rubric, and actual generated result. Do not require exact wording. Mark a criterion met only if the generated result demonstrates it. Give concise Korean rationale and evidence for every criterion.",
                    },
                    {
                        "role": "user",
                        "content": [
                            {"type": "text", "text": json.dumps({
                                "question": question_text, "learner_prompt": answer, "rubric": criteria,
...
class AipotPracticalEvaluator:
    ...
    def evaluate(self, *, exam_id: str, question: dict[str, Any], answer: str, confirm_media: bool) -> dict[str, Any]:
        ...
        question_hash = self._hash({"prompt": question.get("prompt"), "rubric": question.get("rubric"), "evaluation": spec})
        ...
        try:
            ...
            criteria = self.client.judge(
                question_text=str(question.get("prompt", "")), answer=answer,
                rubric=list(question.get("rubric", [])), execution=execution,
            ...
            response = {
                ...
                "artifact": artifact, "cost_usd": execution.cost_usd,
            }
